...
/**
 * Client component for courses page
...
export function CoursesClient({
    ...
    // Use initial data from server for first render (no loading state needed!)
    ...
    useEffect(() => {
        // Skip initial load - we already have data from server
        if (!hasFiltersApplied && page === 1) {
            return
        }
    ...
    }, [filterKey, page, hasFiltersApplied])
    ...
    const handleFiltersChange = (newFilters: CourseFilters) => {
        ...
        setPage(1)
        setHasFiltersApplied(true) // Mark that user has interacted with filters
    }
